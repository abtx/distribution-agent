...
say "Create a read-write key for Distribution Agent. The full key is shown once."
open_url "https://zernio.com/dashboard/api-keys"
step "Sign up or sign in, create a key named Distribution Agent, and copy the full key."
ask_secret ZERNIO_API_KEY "Paste the Zernio API key:"
write_env ZERNIO_API_KEY "$ZERNIO_API_KEY"

stage "Connect Reddit"
